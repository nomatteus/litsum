...
var hashgrid = function(set) {
    ...
    var options = {
        ...
        classNumber = 1,
        gridLines, gridWidth, i, line, lineHeight, numGridLines, overlay, overlayCookie, overlayEl, overlayOn = false,
        overlayVert, overlayZState = 'B',
        overlayZBackground = -1,
        overlayZForeground = 9999,
        pageHeight, setKey, state, sticky = false,
        top;
    ...
    overlayVert.children().height(pageHeight).css({
